...
>
  <h3 style={{ marginTop: 0 }}>📝 Nhập Báo cáo Tiêu chí Tình nguyện tốt</h3>
 {lastSaved && (
    <span
      style={{
        fontSize: "12px",
...
{files.map((file) => {
  const url =
    ...
    `/storage/v1/object/public/Ho%20so%20SV5T/${userId}/tinh-nguyen/${file.name}`;
