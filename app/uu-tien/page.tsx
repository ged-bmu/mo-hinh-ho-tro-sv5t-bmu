...
>
  <h3 style={{ marginTop: 0 }}>📝 Nhập Báo cáo Tiêu chuẩn ưu tiên</h3>
...
{files.map((file) => {
  const url =
    ...
    `/storage/v1/object/public/Ho%20so%20SV5T/${userId}/uu-tien/${file.name}`;
