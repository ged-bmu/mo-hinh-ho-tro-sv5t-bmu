...
function HocTapPage() {
  ...
  const defaultReport = `
<p>1. Điểm trung bình năm học ${currentAcademicYear?.name || ""}: .../4.0.</p>
<p>2. &nbsp;</p>
`;
...
setReport(
  reportData?.content?.trim()
    ? reportData.content
    : `
<p>1. Điểm trung bình năm học ${academicYearName || ""}: .../4.0.</p>
<p>2. &nbsp;</p>
`
);
}
    ...
    >
      ...
      >
        <div style={{ maxWidth: "900px", margin: "0 auto" }}>
          ...
          >
             <Image src="/iconhoctap.png" width={32} height={32} alt="Học tập tốt" style={{ display: "inline-block", verticalAlign: "middle", marginRight: 6 }} /> Học tập tốt
          </h1>
<div
  style={{
    background: "white",
  ...
  const fileUrl =
    file.storage_type === "google_drive"
      ...
      : supabase.storage
          .from("Ho so SV5T")
          .getPublicUrl(
            `${userId}/hoc-tap/${file.storage_name}`
          ).data.publicUrl;
...
export default function HocTapPageWrapper() {
  return (
